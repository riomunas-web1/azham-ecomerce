...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    $insertSQL = sprintf("INSERT INTO barang_jenis (sid, nama_jenis, keterangan) VALUES (uuid(), %s, %s)", GetSQLValueString($_POST['nama_jenis'], "text"), GetSQLValueString($_POST['keterangan'], "text"));
            ...
            <table align="center">
                <tr valign="baseline">
                    ...
                    <td><select name="nama_jenis">
                            <option value="accesories" <?php if (!(strcmp("accesories", ""))) {
    echo "SELECTED";
} ?>>accesories</option>
                            <option value="camera" <?php if (!(strcmp("camera", ""))) {
    echo "SELECTED";
} ?>>camera</option>
                            <option value="computer" <?php if (!(strcmp("computer", ""))) {
    echo "SELECTED";
} ?>>computer</option>
                            <option value="laptop" <?php if (!(strcmp("laptop", ""))) {
    echo "SELECTED";
} ?>>laptop</option>
                            <option value="gadget" <?php if (!(strcmp("gadget", ""))) {
    echo "SELECTED";
} ?>>gadget</option>
                            <option value="printer" <?php if (!(strcmp("printer", ""))) {
    echo "SELECTED";
} ?>>printer</option>
                        </select></td>
                </tr>
