...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO pemesanan_detail (id_pesan, jumlah, harga_beli) VALUES (%s, %s, %s)",
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="jumlah" maxlength="11" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Harga_beli:</td>
      <td><input type="text" name="harga_beli" maxlength="11" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
