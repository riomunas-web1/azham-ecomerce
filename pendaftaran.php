...
<div id="main_container">
  ...
  <div id="main_content">
    <div id="menu_tab">
      ...
      <ul class="menu">
        ...
        <li class="currencies">Currencies
          <select>
            <option selected="selected">Rupiah</option>
    ...
    <div class="left_content">
      ...
      <ul class="left_menu">
        <li class="odd"><a href="http://all-free-download.com/free-website-templates/">Accesories</a></li>
        <li class="even"><a href="http://all-free-download.com/free-website-templates/">Camera</a></li>
        <li class="odd"><a href="http://all-free-download.com/free-website-templates/">Computer</a></li>
        <li class="even"><a href="http://all-free-download.com/free-website-templates/">Laptops</a></li>
        <li class="odd"><a href="http://all-free-download.com/free-website-templates/">Gadget</a></li>
        <li class="even"><a href="http://all-free-download.com/free-website-templates/">Printer</a></li>
        <li class="odd"></li>
      </ul>
      ...
      <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
          <div class="contact_form">
            <div class="form_row">
            <?php
      Include ("input_form_register.php");
      ?>
            </div>
</div>
        </div>
    ...
    <div class="right_content">
      ...
      <ul class="left_menu">
        ...
        <li class="odd"><a href="http://all-free-download.com/free-website-templates/">Toshiba</a></li>
        <li class="even"><a href="http://all-free-download.com/free-website-templates/">LG</a></li>
        <li class="odd"><a href="http://all-free-download.com/free-website-templates/">Iphone</a></li>
